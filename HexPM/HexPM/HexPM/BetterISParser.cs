    ...
    class BetterISParser
    {
        ...
        public static void parseIS(string fileName)
        {
            ...
            for (int i = 0; i < text.Length; i++)
            {
                ...
                if (textSplit[0] == "msg")
                {
                    Console.WriteLine("\n" + textSplit[1] + " (Press any key to continue)");
                ...
                {
                    Console.WriteLine("\nSaving installation in installhistory...");
                    ...
                    {
                        System.IO.File.AppendAllText(@"C:\Users\" + Environment.UserName + @"\AppData\Roaming\HexPM\installhistory.txt", "\n" + saveInstallSplit[0] + ";" + saveInstallSplit[1] + ";" + @"C:\Users\" + Environment.UserName + @"\AppData\Roaming\Microsoft\Windows\Start Menu\Programs" + @"\" + saveInstallSplit[0] + ".lnk" + ";" + now.ToString("F") + ";EnvVarFalse");
                    }
                }
